                    ...
                    <div class="col-span-4 sm:col-span-9">
                        <div class="bg-white shadow rounded-lg p-6">
                            ...
                            <p class="text-gray-700">
                                ...
                                adipiscing elit. Sed finibus est vitae tortor
                                ullamcorper, ut vestibulum velit convallis.
                                Aenean posuere risus non velit egestas suscipit.
                                Nunc finibus vel ante id euismod. Vestibulum
                                ante ipsum primis in faucibus orci luctus et
                                ultrices posuere cubilia Curae; Aliquam erat
                                volutpat. Nulla vulputate pharetra tellus, in
                            ...
                            <div
                                class="flex justify-center items-center gap-6 my-6"
                            >
                                <a
